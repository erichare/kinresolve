...
export default function PricingPage() {
  return (
    <>
      <PageHero
        eyebrow="Pricing"
        lead="Every way to use Kin Resolve today is free: the synthetic public demo, the invitation-only hosted beta, and self-hosting the AGPL source. There are no price tiers to compare yet—only the commitments below."
      ...
      <section className="section surface-section">
        <div className="shell status-table-wrap">
          ...
          <div className="status-table">
            {tiers.map((tier) => (
              <div className="status-column" key={tier.name}>
      ...
      <section className="shell section public-roadmap">
        ...
        <div>
          ...
          <p>Two commitments hold in the meantime: hosted plans will be announced before anything costs money, and beta participants get clear notice first. Self-hosting stays free under the AGPL regardless of what hosted plans become, and full GEDCOM export means a price change can never hold an archive hostage.</p>
      ...
      <div className="shell section">
        <CtaStrip
          body="Start in a temporary fictional workspace, or apply to test your real research workflow when invitations begin. Neither costs anything."
