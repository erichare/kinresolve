...
import { createPublicDemoGedcomExport } from "@/lib/public-demo-exports";
...
export const GET = withDemoGuestCapability("demo:export", async (request, guest) => {
  ...
  try {
    ...
    const result = createPublicDemoGedcomExport(workspace);
    ...
    await captureOperationalError({
      ...
      route: "/api/demo/exports/gedcom"
    }, error);
    return privateJson({ error: "Unable to export the fictional demo GEDCOM." }, 500);
  }
});
